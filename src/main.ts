...
import { drawCanvas, drawFigure } from "./draw";
import { FIGURES, randomFigure } from "./figures";
import { breakDown, checkConnection, pinFigure } from "./game_logic";
...
const spawnFigure = () => {
    ...
    if (!checkForColision(nextFigure, arr, fig_x, fig_y))
        return nextFigure
